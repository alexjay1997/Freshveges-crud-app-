        ...
        <div class="header">
            ...
            <div class="container">
                ...
                <div class="main-content">
                        <div class="tblview" >
                        <h2 style="color:grey;margin:50px auto;text-align:center;font-family:myfont;font-weight:300px;color:Green;">Edit Vegatables </h2>
                            <table>
                            <tr>
                                    <th>
                                       Item Code
                               ...
                               while($row=mysqli_fetch_array($result))
                               {
                                ...
                                <td><?php echo $row['ItemCode'];?></td>
                                    ...
                                    <td style="background-color:#459078;"><a href="update.php?id=<?php echo $row['ItemCode'];?>" style="text-decoration:none;color:white;padding:7px;text-align:center;">Edit</a></td>
                                </tr>
                                <?php
                               }
                                ?>
